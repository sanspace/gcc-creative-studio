...
from src.multimodal.gemini_service import GeminiService, PromptTargetEnum, ResponseMimeTypeEnum
...
async def test_enhance_prompt_from_dto_success(gemini_service):
    dto = CreateImagenDto(prompt="test prompt", generation_model="imagen-3.0-generate-002", workspace_id=1)
...
def test_aggregate_brand_info_success(gemini_service):
    partial = [{"color_palette": ["#000"], "tone_of_voice_summary": "cool", "visual_style_summary": "sleek", "workspace_id": "123", "name": "Brand X"}]

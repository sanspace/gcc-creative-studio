...
def test_generate_image_thumbnail_from_gcs_success():
    ...
    with patch("src.common.media_utils.generate_image_thumbnail_bytes") as mock_gen_bytes:
        mock_gen_bytes.return_value = b"fakethumb"
        
        res = generate_image_thumbnail_from_gcs(mock_gcs, "gs://bucket/image.png", "image/png")
        
        assert res == "gs://bucket/image_thumbnail.png"
        mock_gcs.upload_bytes_to_gcs.assert_called_once_with(b"fakethumb", "image_thumbnail.png", "image/png")
